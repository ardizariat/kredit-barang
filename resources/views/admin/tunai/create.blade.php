...
@section('admin-content')
      ...
      <div class="container-fluid">
          ...
          <div class="col-md-6">
           <nav aria-label="breadcrumb">
             <ol class="bg-gray-200 breadcrumb float-right">
               ...
               <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('admin.transaksi.tunai') }}">Transaksi Tunai</a></li>
        ...
        <div class="card border-left-primary animate__animated animate__fadeIn shadow mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('admin.transaksi.tunai.store') }}" method="POST">
              @csrf
              <div class="form-group">
                <label for="pelanggan"><b>Pelanggan</b></label>                
                <select autocomplete="off" name="pelanggan_id" class="pelanggan-id select2 form-control @error('pelanggan_id') is-invalid @enderror">
              ...
              <div class="form-group">
                ...
                <select name="barang_id" class="select2 barang-id form-control @error('barang_id') is-invalid @enderror" id="barang">
...
<script>
  $(document).ready(function(){
    $('form').on('change', '.barang-id', function(){
      ...
      $.ajax({
        type      : "GET",
        url       : "{!! route('admin.transaksi.tunai.create.barang') !!}",
        data      : {'id':id},
        dataType  : "json",
        success   : function(data){
